  ...
  return (
    <div className="glass rounded-3xl p-6 border border-white/10 hover:border-white/20 transition-all h-full flex flex-col">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
        <h3 className="text-xl font-bold text-white tracking-tight">Live Chart</h3>
      ...
      <div className="w-full flex-1 min-h-[500px] rounded-2xl overflow-hidden bg-gray-900 border border-white/10 shadow-2xl">
        <iframe
