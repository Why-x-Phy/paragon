...
export default function TokenPurchase() {
  ...
  return (
    <div className="glass rounded-3xl p-6 border border-white/10 hover:border-white/20 transition-all">
      <div className="mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {PACKAGES.map((pkg, index) => (
          <div
            key={index}
            className={`relative premium-card rounded-3xl p-6 border transition-all cursor-pointer ${
