...
export default function TokenPurchase() {
  ...
  return (
    <div className="glass rounded-3xl p-8 border border-white/10 hover:border-white/20 transition-all">
      <div className="mb-8">
        <h3 className="text-xl font-bold text-white mb-2 tracking-tight">Token kaufen</h3>
        <p className="text-sm text-gray-400 font-medium">Wähle ein Paket und zahle mit Thirdweb Pay</p>
      </div>
