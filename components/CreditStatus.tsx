  ...
  return (
    <div className="glass rounded-3xl p-8 border border-white/10 hover:border-white/20 transition-all">
      <div className="flex items-center justify-between mb-6">
        ...
        <span className={`text-xs font-bold px-3 py-1.5 rounded-lg ${getStatusColor()} bg-opacity-10 border border-current border-opacity-20`}>
          {getStatusText()}
        </span>
      </div>
      <div className="space-y-3">
        <div className="flex items-baseline gap-2">
          ...
          <span className="text-base text-gray-400 font-medium">verfügbar</span>
        </div>
