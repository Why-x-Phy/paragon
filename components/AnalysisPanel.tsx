      ...
      {!analysis ? (
        <div className="space-y-6">
          <button
            ...
            className={`w-full py-5 rounded-xl font-bold text-white transition-all text-lg ${
              !account || credits < 1 || isAnalyzing
                ? "bg-gray-700 cursor-not-allowed opacity-50"
                : "bg-white/10 hover:bg-white/20 border border-white/20 shadow-lg hover:shadow-xl hover:scale-[1.02]"
            }`}
          >
            {isAnalyzing ? (
